...
public class TimePickerDialog extends DialogFragment implements View.OnClickListener {
    ...
    View initView() {
        ...
        LinearLayout linear_wheel = view.findViewById(R.id.linear_wheel);
        ...
        linear_wheel.setBackgroundColor(mPickerConfig.mBackgroundColor);
    ...
    */
    ...
    public static class Builder {
        ...
        public Builder setBackgroundColor(int color) {
            mPickerConfig.mBackgroundColor = color;
            return this;
        }
