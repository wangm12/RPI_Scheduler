package com.envision.timepickerdialog;

import android.content.Context;
import android.view.View;

import com.envision.timepickerdialog.adapters.NumericWheelAdapter;
import com.envision.timepickerdialog.config.PickerConfig;
import com.envision.timepickerdialog.data.source.TimeRepository;
import com.envision.timepickerdialog.utils.PickerContants;
import com.envision.timepickerdialog.utils.Utils;
import com.envision.timepickerdialog.wheel.OnWheelChangedListener;
import com.envision.timepickerdialog.wheel.WheelView;
...
public class TimeWheel {
    ...
    void initView(View view) {
        ...
        year.setTag(view.findViewById(R.id.yearTip));
        month.setTag(view.findViewById(R.id.monthTip));
        day.setTag(view.findViewById(R.id.dayTip));
        hour.setTag(view.findViewById(R.id.hourTip));
        minute.setTag(view.findViewById(R.id.minuteTip));
        ...
        year.setBackgroundColor(mPickerConfig.mBackgroundColor);
        month.setBackgroundColor(mPickerConfig.mBackgroundColor);
        day.setBackgroundColor(mPickerConfig.mBackgroundColor);
        hour.setBackgroundColor(mPickerConfig.mBackgroundColor);
        minute.setBackgroundColor(mPickerConfig.mBackgroundColor);
    }
